...
(function($, undefined) {
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			swfPath: "libs/jplayer", // Path to Jplayer.swf. Can be relative, absolute or server root relative.
			solution: "flash", // Valid solutions: html, flash. Order defines priority. 1st is highest,
